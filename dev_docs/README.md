...
- [`development.md`](development.md): local build, native build, verification, and release hygiene
- [`token-accounting.md`](token-accounting.md): Codex and Claude Code token attributes, credit/cost math, usage polling, and trigger classification
