...
public class RateCard {
    ...
    private static final Map<String, double[]> RATES = Map.ofEntries(
            ...
            Map.entry("gpt-5.3-codex-spark", new double[]{0, 0, 0}),
            Map.entry("gpt-5.3-codex", new double[]{43.75, 4.375, 350}),
            Map.entry("gpt-5.2", new double[]{43.75, 4.375, 350}),
            // Codex OTLP completion rows do not distinguish image and text tokens.
            // Use the image rate so mixed input is estimated at the published upper bound.
            Map.entry("gpt-image-2", new double[]{200, 50, 750}),
            Map.entry("gpt-image-2.0", new double[]{200, 50, 750}),
